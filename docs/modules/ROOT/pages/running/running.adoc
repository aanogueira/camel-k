...
Integrations can be written in multiple languages. We provide an archive with common examples in the https://github.com/aanogueira/camel-k/releases[release page].
